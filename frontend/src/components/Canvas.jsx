...
const Canvas = ({ blocks, onBlockDelete, onBlockDuplicate, onShowCode, onReorderBlock }) => {
      ...
      <div className="max-w-full">
        {blocks.map((block, index) => (
          <div
            ...
            className="relative group border-2 border-transparent hover:border-blue-500 transition-all"
            draggable
          ...
          >
            ...
            <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity flex gap-2">
              ...
              <Button
                ...
                variant="secondary"
                className="h-8 w-8 bg-white hover:bg-gray-100 shadow-lg"
                onClick={() => onBlockDuplicate(block)}
                title="Duplicate"
              >
              ...
              <Button
                ...
                variant="secondary"
                className="h-8 w-8 bg-white hover:bg-gray-100 shadow-lg"
                onClick={() => onBlockDelete(block.instanceId)}
                title="Delete"
              >
